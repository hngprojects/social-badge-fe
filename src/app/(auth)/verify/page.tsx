...
const Page = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm p-4">
        ...
        <div className="w-full max-w-md rounded-[24px] bg-white p-8 shadow-[0px_20px_60px_rgba(0,0,0,0.12)]">
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold text-[#121217]">Verifying Email</h2>
      ...
      {isError && (
        <div className="w-full max-w-md rounded-[24px] bg-white p-8 shadow-[0px_20px_60px_rgba(0,0,0,0.12)]">
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold text-[#121217]">Verification Failed</h2>
      ...
      {!isLoading && !isError && <VerifyEmailModal />}
    </div>
  );
};
