...
export default function WaitlistSuccessPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#F9F9F9] overflow-hidden flex flex-col justify-center items-center py-12 px-4 md:px-6">
      {/* Background Blobs */}
      ...
      <div className="relative flex items-center justify-center w-full bg-gray-50 md:p-6">
          ...
          <div className="flex-1 space-y-6 py-6">
            ...
            <div className="space-y-4 md:space-y-3">
              <h1 className="text-5xl md:text-5xl font-sans font-bold text-[#1E1E1E] leading-tight mb-7">
                Successful ! <br />
                You&appos;ve Joined the Waitlist!
              </h1>
              <p className="text-[#757575] text-[18px] font-semibold max-w-sm">
                We&appos;ll notify you as soon as Social Badge Builder is ready.
              </p>
            </div>
